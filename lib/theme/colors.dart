...
class AppColors {
  // App Specific
  static const Color primary = Color(0xFF051229);
  ...
  static const Color lightWhite = Color(0xFFFAFBFF);
  static const Color black = Color(0xFF000000);
  static const Color blue = Color(0xFF0000FF);
  static const Color darkBlue = Color(0xFF173C47);
  static const Color lightGrey = Color(0xFFD9D9D9);
  static const Color searchBar = Color(0xFFF4F5F6);
  static const Color darkGrey = Color(0xFF858585);
  static const Color mediumGrey = Color(0xFF343434);
